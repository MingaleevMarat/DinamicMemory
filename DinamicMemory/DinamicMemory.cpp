// DinamicMemory.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//

//#include <iostream>
//void Print(int array[], const unsigned int size);
//void Print(int** array, const int rows, const int cols);
//void FillRand(int array[], const unsigned int size);
//void FillRand(int** array, const int rows, const int cols);
//int* push_back(int array[],  unsigned int& size,int value);
//int** allocate(const unsigned int rows, const unsigned int cols);
//void clear(int** array, const unsigned int rows);
...
//
//    int value;
//    std::cout << "Enter dob value:";
//    std::cin >> value;
//
//    array = push_back(array, size, value);
//    Print(array, size);
//
//
//    delete[] array;
...
//
//    int rows, cols;
//    std::cout << "Enter kol strings:";
//    std::cin >> rows;
//    std::cout << "Enter kol elements strings:";
//    std::cin >> cols;
